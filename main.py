...
sistem.AddMassPoint("point1", Vector2(100, 400), 1000000, 0)
...
sistem.AddMassPoint("point6", Vector2(350, 400), 500, 1000)
...
sistem.AddMassPoint("point13", Vector2(700, 400), 1000000, 0)
